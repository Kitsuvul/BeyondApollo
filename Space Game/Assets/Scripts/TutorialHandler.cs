...
public class TutorialHandler : MonoBehaviour
{
    ...
    [SerializeField] private GameObject ftlGateObj, rocketShipObj, cameraObj, exitDirectionArrowObj, boostBarObj, settingsObj, soundObj;
    ...
    void LoadTutorialStage(int stage)
    {
        switch (stage)
        {
            ...
            case 2:
                ...
                // Draw Arrow
                exitDirectionArrowObj.GetComponent<ExitArrowHandler>().tutorialActivated = true;
            ...
            case 3:
                // Introduce exit
                exitDirectionArrowObj.GetComponent<ExitArrowHandler>().tutorialActivated = false;
